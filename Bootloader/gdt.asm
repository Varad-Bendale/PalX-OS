...
; now there is this 0xffff these are like see limit to all the bits for the cpu as the main work of gdt is to make the cpu ready for the 32 bit thing work now
